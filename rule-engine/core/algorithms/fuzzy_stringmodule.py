...
def approx_local_points(self, string1, string2):
    length1 = len(string1)
    length2 = len(string2) 
    ...
    alignment_matrix = approx_alignment_matrix(False, string1, string2, length1, length2)
    ...
    if length1 < _minimumstring or length2 < _minimumstring:
        ...
        return match[0] + approx_local_points(string1, string2, length1, length2)
...
def approx_global_points(string1, string2):
    alignment_matrix = approx_alignment_matrix(True)
